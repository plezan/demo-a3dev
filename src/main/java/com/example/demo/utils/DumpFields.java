...
public class DumpFields {
    public static <T> ArrayList<String> inspectBaseAttribut(Class<T> klazz) {
        ...
        while (superClass.getSuperclass() != DbEntity.class
    ...
    public static <T extends DbEntity> Object runGetter(Field field, T o) {
    ...
    public static <T> ArrayList<String> inspectGetter(Class<T> klazz) {
        ...
        try {
            for (PropertyDescriptor propertyDescriptor : Introspector
                    .getBeanInfo(klazz, DbEntity.class)
    ...
    public static <O extends DbEntity> Class<?> getAssociatedDB(O item) {
